...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Cuántos litros son 50 cl.
		System.out.println("50 cl son " + 50 * Unidades.centilitros + " litros.");

		// Igualmente podemos acceder al atributo estático quilometros anteponiendo el
		// nombre de la clase (Unidades).
		// Cuántos metros son 2.5km
		System.out.println("2,5k son " + 2.5 * Unidades.quilometros + " m.");
