...
public class Ejemplo09 {
	...
	public static void main(String[] args) {
		...
		System.out.println("El precio final de un artículo que vale 100 euros y se le "
				+ "\naplica un descuento del 30% y una IVA del 21% es " + precioVenta(100, 30, 21) + " euros.");
