...
public class Main {
	...
	// Este método toma un parámetro de tipo Figura2D. Eso significa que le podemos
	// pasar
	// como argumento cualquier objeto de una clase que implemente Figura2D, como un
	// Círculo,
	// o un Rectángulo.
