...
public class Ejemplo09 {
	...
	public static void main(String[] args) {
		...
		System.out.println("La temperatura de ebullición del agua es " 
				+ TEMPERATURA_EBULLICION_AGUA + "ºC.");
		
		System.out.println("El compresor de la cámara frigorífica "
				+ "funcionará mientras no se alcance la temperatura de " 
				+ TEMPERATURA_DESEADA_CAMARA + "ºC.");
