...
public class Ejer2 {
	public static void main(String[] args) {
		 ...
		 * Utiliza while y break Añade al final del programa anterior el código
		 * necesario para que indique la puntuación obtenidapor el jugador: •Si ha
		 * acertado en un intento → Recibe 10 puntos. •Si ha acertado en dos intentos →
		 * Recibe 5 puntos. •Si ha acertado en tres intentos → Recibe 2 puntos. •En otro
		 * caso → Recibe 0 puntos
		 */
