...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		System.out.println("=================================");
		System.out.println("\nDime un número con la unidad Kilómetros y te lo convertiré en Millas");
		...
		System.out.println("====================================");
		System.out.println("\nDime un número con la unidad Milibares y te lo convertiré en Atmósferas");
		...
		System.out.println("===============================");
		System.out.println("\nDime un número con la unidad Calorias y te lo convertiré en Julios");
